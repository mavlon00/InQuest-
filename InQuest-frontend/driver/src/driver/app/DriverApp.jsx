...
// ── Guard: KYC gate ───────────────────────────────────────────────
function KYCGuard() {
  const { kyc_status } = useDriverStore();
  switch (kyc_status) {
    ...
    default:            return <Outlet />; // allow access during loading/initial state
  }
}
...
export default function DriverApp() {
  const { accessToken, setCurrentLocation, isOnline } = useDriverStore();
