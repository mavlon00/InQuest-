  ...
  const fetchEstimate = async (withInsurance = false) => {
    ...
    try {
      ...
      const est = {
        ...
        totalFare: baseEstimate.baseFare +
          baseEstimate.deadMileageFee +
      ...
      // fallback
      setEstimate({ baseFare: 500, deadMileageFee: 150, stopFees: 0, distanceKm: 5.2, durationMins: 15, totalFare: 650 });
      setFareEstimate({ baseFare: 500, deadMileageFee: 150, stopFees: 0, distanceKm: 5.2, durationMins: 15, totalFare: 650 });
    } finally {
      setLoading(false);
    }
  };
