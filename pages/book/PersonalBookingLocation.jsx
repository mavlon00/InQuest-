...
import { useBookingStore, mockSavedPlaces, mockRecentTrips } from '../../store/bookingStore';
...
async function reverseGeocode(lat, lng) {
  // In production: call Nominatim or Google reverse geocode
  return '15 Aba Johnson Close, Lekki Phase 1, Lagos';
}
