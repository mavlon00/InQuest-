...
import { 
  ...
  ArrowLeft, Gift, ChevronLeft, SlidersHorizontal 
} from 'lucide-react';
      ...
      <main className="flex-1 overflow-y-auto px-6 py-4 space-y-10 relative z-10">
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  <h2 className="text-5xl font-display font-bold tracking-tight">12,450<span className="text-2xl text-white/30 font-normal">.00</span></h2>
                </div>
              </div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3 pb-10">
            {[
              { id: '1', type: 'credit', title: 'Wallet Top-up', desc: 'Auto-load via Mastercard', amount: '5,000.00', time: '10:30 AM' },
              { id: '2', type: 'debit', title: 'Route Commute', desc: 'Ride to Ikeja City Mall', amount: '1,250.00', time: 'Yesterday' },
              { id: '3', type: 'debit', title: 'Peer Transfer', desc: 'Transfer to John Doe', amount: '2,000.00', time: '22 Oct' },
            ].map((tx, i) => (
              <motion.div 
                key={tx.id}
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/30 font-medium">{tx.desc} • {tx.time}</p>
                  </div>
                </div>
