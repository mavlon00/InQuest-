    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-32 bg-surface-1">
      <div className="w-full max-w-2xl bg-surface-0 rounded-3xl border border-surface-2 shadow-2xl p-8 md:p-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {/* Passenger Option */}
          <div className="bg-surface-1 border border-surface-2 rounded-2xl p-6 hover:border-primary/50 transition-colors cursor-pointer group">
            ...
            <p className="text-sm text-text-secondary mb-6">Create a passenger account to verify vehicles and ride safely.</p>
            <button className="w-full bg-surface-2 hover:bg-surface-3 text-text-primary py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-2">
          ...
          <div className="bg-surface-1 border border-surface-2 rounded-2xl p-6 hover:border-primary/50 transition-colors cursor-pointer group">
            ...
            <p className="text-sm text-text-secondary mb-6">Start your application to become a verified Inquest driver.</p>
            <button className="w-full bg-primary hover:bg-primary-dim text-on-primary py-3 rounded-xl font-bold transition-all shadow-[0_4px_14px_rgba(127,255,0,0.2)] hover:shadow-[0_6px_20px_rgba(127,255,0,0.3)] flex items-center justify-center gap-2">
